			...
			<div class="col-sm-12" id="produkte">
				...
				<div class="textarea">
					...
					<div id="carousel_products" class="carousel slide" data-ride="carousel">
						...
						<div class="carousel-inner">
							<div class="item active">
								<img src="pictures/Bike1slideshow.jpg" class="carousel-img" alt="xxx">
							</div>

							<div class="item">
								<img src="pictures/Bike2slideshow.jpg" class="carousel-img" alt="xxx">
							</div>

							<div class="item">
								<img src="pictures/Bike3slideshow.jpg" class="carousel-img" alt="xxx">
							</div>
						</div>

						<a class="left carousel-control" href="#carousel_products" data-slide="prev">
							<span class="glyphicon glyphicon-chevron-left"></span>
							<span class="sr-only">Previous</span>
						</a>
						<a class="right carousel-control" href="#carousel_products" data-slide="next">
							<span class="glyphicon glyphicon-chevron-right"></span>
							<span class="sr-only">Next</span>
						</a>
					</div>
